...
module "compute" {
  ...
  public_subnets        = module.networking.wf_public_subnet_ids  # Match expected name in compute
  private_subnets       = module.networking.wf_private_subnet_ids # Match expected name in compute
