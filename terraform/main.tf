...
module "compute" {
  ...
  public_subnets        = module.networking.wf_public_subnets  # Matches variable name exactly
  private_subnets       = module.networking.wf_private_subnets # Matches variable name exactly
